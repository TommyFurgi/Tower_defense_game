...
class TowerMenu():
    ...
    def draw(self, screen, tower_parameters):
        ...
        for fn in draw_ellipse_functions:
            ...
            fn(tower_menu_positions[safe_positions[current_position].value], self.menu_pages[current_page], **tower_parameters)
            current_position += 1
    ...
    def draw_radius(self, tower_menu_surface):
        pygame.draw.circle(tower_menu_surface, 
                           (0, 0, 255, 100), 
                           (self.radius * self.scale_rate * 1.5, self.radius * self.scale_rate * 1.5),
                            self.radius * self.scale_rate, 0)  
        
        
    def draw_cooldown_ellipse(self, position, tower_menu_surface, **kwargs):
        ...
        cooldown_text = self.font.render("Cooldown: " + str(int(kwargs["cooldown"])), True, self.text_color)
    ...
    def draw_damage_ellipse(self, position, tower_menu_surface, **kwargs):
        ...
        damage_text = self.font.render("Damage: " + str(int(kwargs["damage"])), True, self.text_color)
    ...
    def draw_damage_dealt_ellipse(self, position, tower_menu_surface, **kwargs):
        ...
        damage_dealt = int(kwargs["damage_dealt"])
    ...
    def draw_target_mode_ellipse(self, position, tower_menu_surface, **kwargs):
        ...
        target_mode_text = self.font.render(kwargs["tower_target"].value, True, self.text_color)
    ...
    def draw_sell_ellipse(self, position, tower_menu_surface, **kwargs):
        ...
        # Drawing sell price
        text = self.font.render("Price: " + str(kwargs["price"]), True, self.text_color)
    ...
    def draw_upgrade_ellipse(self, position, tower_menu_surface, **kwargs):
        if kwargs["level"] <= 3:
            ...
            level_text = self.font.render("Level: " + str(kwargs["level"]), True, self.text_color)
    ...
    def calculate_menu_positions(self):
        return [(self.radius * self.scale_rate * 1.5 - self.elipse_width // 2, self.radius * self.scale_rate * 0.45 ), # top
